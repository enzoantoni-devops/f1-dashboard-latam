...
function getSVGPlaceholder(circuitName) {
  // Codificar correctamente el nombre del circuito para la imagen SVG
...
<svg xmlns="http://www.w3.org/2000/svg" width="400" height="200" viewBox="0 0 400 200">
  ...
  // Devolver el data URI como una cadena directamente
...
export function sanitizeCircuitName(name) {
  ...
  const mappings = {
    ...
    'Detroit Street Circuit': 'Detroit_gand_Prix',
